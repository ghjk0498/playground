...
import khg.example.playground.postgres.repo.SessionRepository
...
class PostgresSessionService(
    ...
    fun generate(n: Int): GenerateResult {
        ...
        return try {
            ...
            val savedCount = repository.saveAll(entities)
                .count()
                .block() ?: 0L
            ...
            val elapsed = (System.nanoTime() - start) / 1_000_000
            GenerateResult(props.host, props.port, props.database, count, 0, elapsed, e.message ?: e.toString())
        }
    }
}
